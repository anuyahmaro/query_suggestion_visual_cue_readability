...
if ($_GET) {
    ...
    if (isset($_GET["GO"]))
    {
        ...
        curl_setopt($ch, CURLOPT_HTTPHEADER,
            array("Ocp-Apim-Subscription-Key: 14c4516f78c342bf83b0d129c19cfe70", "Content-Type: application/json"));
...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <br>
            <a href="index.php" style="text-decoration: none"><button style="color: #6666ff"><b>Home Page</b></button></a>
            <form id="search-form" action="" method="GET">
                <center>
                    <a href = "#"><img src="search_2.png" alt="image" class="img img-responsive"  style="height:20%;"></a>
                    <br>

                    <input id="searchinput" autocomplete="off" data-toggle="popover" data-container="body" data-placement="bottom" data-html="true" type="text" placeholder="Enter Search or Type URL..." style="font-size:20px;font-family: arial,sans-serif;height:40px;width:750px;" value ='<?php echo (isset($searchquery)?$searchquery:"")?>'  name="GO">
                    ...
                    <input type="submit" style="height:40px;width:40px; " id="go" value="GO">
                </center>
